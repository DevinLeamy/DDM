...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_register_page_register_page_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./components/register-page/register-page.component */
    "./src/app/components/register-page/register-page.component.ts");
    /* harmony import */


    var _components_login_page_login_page_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./components/login-page/login-page.component */
    "./src/app/components/login-page/login-page.component.ts");
    /* harmony import */
    ...
    var _services_authentication__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./services/authentication */
    "./src/app/services/authentication.ts");
    /* harmony import */


    var _services_user__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./services/user */
    ...
    var _components_create_chat_create_chat_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! ./components/create-chat/create-chat.component */
    "./src/app/components/create-chat/create-chat.component.ts");
    /* harmony import */


    var _components_home_page_chat_display_chat_display_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    ...
    var _components_user_page_user_page_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
    /*! ./components/user-page/user-page.component */
    "./src/app/components/user-page/user-page.component.ts");
    /* harmony import */


    var _components_user_icon_user_icon_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    /*! ./components/user-icon/user-icon.component */
    "./src/app/components/user-icon/user-icon.component.ts");
    /* harmony import */


    var _components_chat_page_message_view_chat_title_chat_title_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
    ...
    var _components_chat_page_message_view_chat_title_chat_subscribe_chat_subscribe_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
    ...
    var _components_chat_page_subscribers_view_subscribers_view_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
    ...
    var _components_chat_page_message_view_messages_messages_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
    ...
    var _components_user_page_user_friends_view_user_friends_view_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
    ...
    var _components_user_page_user_view_user_view_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
    /*! ./components/user-page/user-view/user-view.component */
    "./src/app/components/user-page/user-view/user-view.component.ts");
    /* harmony import */


    var _components_user_page_user_chats_view_user_chats_view_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(
    ...
    var _components_image_fab_image_fab_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(
    /*! ./components/image-fab/image-fab.component */
    "./src/app/components/image-fab/image-fab.component.ts");
    /* harmony import */


    var _components_create_chat_chat_tags_chat_tags_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(
    /*! ./components/create-chat/chat-tags/chat-tags.component */
    "./src/app/components/create-chat/chat-tags/chat-tags.component.ts");
    /* harmony import */


    var _components_create_chat_chat_tags_tag_tag_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(
    ...
    var _components_chat_page_subscribers_view_subscriber_subscriber_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(
    ...
    var _components_chat_selection_chat_selection__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(
    /*! ./components/chat-selection/chat-selection */
    "./src/app/components/chat-selection/chat-selection.ts");
    /* harmony import */


    var _components_chat_selection_chat_option_chat_option__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(
    /*! ./components/chat-selection/chat-option/chat-option */
    "./src/app/components/chat-selection/chat-option/chat-option.ts");
    /* harmony import */


    var _components_home_page_recent_chats_recent_chats_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(
    /*! ./components/home-page/recent-chats/recent-chats.component */
    "./src/app/components/home-page/recent-chats/recent-chats.component.ts");
    /* harmony import */


    var _components_home_page_popular_chats_popular_chats_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(
    /*! ./components/home-page/popular-chats/popular-chats.component */
    "./src/app/components/home-page/popular-chats/popular-chats.component.ts");
    /* harmony import */


    var _components_home_page_recommended_chats_recommended_chats_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(
    /*! ./components/home-page/recommended-chats/recommended-chats.component */
    "./src/app/components/home-page/recommended-chats/recommended-chats.component.ts");
    /* harmony import */


    var _components_chat_page_message_view_chat_title_chat_subscribe_chat_subscribe_admin_dialog_chat_subscribe_admin_dialog_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(
    ...
    var _components_chat_icon_chat_icon_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(
    /*! ./components/chat-icon/chat-icon.component */
    "./src/app/components/chat-icon/chat-icon.component.ts");
    /* harmony import */


    var _components_user_page_user_friends_view_friend_request_friend_request_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(
    ...
    var _components_chat_page_global_chat_related_chats_related_chats_component__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [{
        ...
        multi: true
      }, _services_authentication__WEBPACK_IMPORTED_MODULE_20__["AuthenticationService"], _services_user__WEBPACK_IMPORTED_MODULE_21__["UserService"]],
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_19__["AppComponent"], _components_home_page_home_page_component__WEBPACK_IMPORTED_MODULE_15__["HomePageComponent"], _components_login_page_login_page_component__WEBPACK_IMPORTED_MODULE_17__["LoginPageComponent"], _components_register_page_register_page_component__WEBPACK_IMPORTED_MODULE_16__["RegisterPageComponent"], _components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_18__["NavbarComponent"], _components_chat_page_message_view_message_view_component__WEBPACK_IMPORTED_MODULE_24__["MessageViewComponent"], _components_chat_page_message_view_message_create_message_create_component__WEBPACK_IMPORTED_MODULE_25__["MessageCreateComponent"], _components_chat_page_message_view_messages_message_received_message_received_component__WEBPACK_IMPORTED_MODULE_26__["MessageReceivedComponent"], _components_chat_page_message_view_messages_message_sent_message_sent_component__WEBPACK_IMPORTED_MODULE_27__["MessageSentComponent"], _components_chat_page_global_chat_global_chat_component__WEBPACK_IMPORTED_MODULE_22__["GlobalChatComponent"], _components_create_chat_create_chat_component__WEBPACK_IMPORTED_MODULE_28__["CreateChatComponent"], _components_home_page_chat_display_chat_display_component__WEBPACK_IMPORTED_MODULE_29__["ChatDisplayComponent"], _components_user_page_user_page_component__WEBPACK_IMPORTED_MODULE_30__["UserPageComponent"], _components_user_icon_user_icon_component__WEBPACK_IMPORTED_MODULE_31__["UserIconComponent"], _components_chat_page_message_view_chat_title_chat_title_component__WEBPACK_IMPORTED_MODULE_32__["ChatTitleComponent"], _components_chat_page_message_view_chat_title_chat_subscribe_chat_subscribe_component__WEBPACK_IMPORTED_MODULE_33__["ChatSubscribeComponent"], _components_chat_page_subscribers_view_subscribers_view_component__WEBPACK_IMPORTED_MODULE_34__["SubscribersViewComponent"], _components_chat_page_message_view_messages_messages_component__WEBPACK_IMPORTED_MODULE_35__["MessagesComponent"], _components_user_page_user_friends_view_user_friends_view_component__WEBPACK_IMPORTED_MODULE_36__["UserFriendsViewComponent"], _components_user_page_user_view_user_view_component__WEBPACK_IMPORTED_MODULE_37__["UserViewComponent"], _components_user_page_user_chats_view_user_chats_view_component__WEBPACK_IMPORTED_MODULE_38__["UserChatsViewComponent"], _components_image_fab_image_fab_component__WEBPACK_IMPORTED_MODULE_39__["ImageFabComponent"], _components_create_chat_chat_tags_chat_tags_component__WEBPACK_IMPORTED_MODULE_40__["ChatTagsComponent"], _components_create_chat_chat_tags_tag_tag_component__WEBPACK_IMPORTED_MODULE_41__["TagComponent"], _components_header_header_component__WEBPACK_IMPORTED_MODULE_42__["HeaderComponent"], _components_chat_page_subscribers_view_subscriber_subscriber_component__WEBPACK_IMPORTED_MODULE_43__["SubscriberComponent"], _components_chat_selection_chat_selection__WEBPACK_IMPORTED_MODULE_44__["ChatSelectionComponent"], _components_chat_selection_chat_option_chat_option__WEBPACK_IMPORTED_MODULE_45__["ChatOptionComponent"], _components_home_page_recent_chats_recent_chats_component__WEBPACK_IMPORTED_MODULE_46__["RecentChatsComponent"], _components_home_page_popular_chats_popular_chats_component__WEBPACK_IMPORTED_MODULE_47__["PopularChatsComponent"], _components_home_page_recommended_chats_recommended_chats_component__WEBPACK_IMPORTED_MODULE_48__["RecommendedChatsComponent"], _components_chat_page_message_view_chat_title_chat_subscribe_chat_subscribe_admin_dialog_chat_subscribe_admin_dialog_component__WEBPACK_IMPORTED_MODULE_49__["ChatSubscribeAdminDialogComponent"], _components_chat_icon_chat_icon_component__WEBPACK_IMPORTED_MODULE_50__["ChatIconComponent"], _components_user_page_user_friends_view_friend_request_friend_request_component__WEBPACK_IMPORTED_MODULE_51__["FriendRequestComponent"], _components_chat_page_global_chat_related_chats_related_chats_component__WEBPACK_IMPORTED_MODULE_52__["RelatedChatsComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_4__["MatInputModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_5__["MatToolbarModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_8__["FlexLayoutModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_9__["BrowserAnimationsModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_10__["MatSidenavModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_11__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_12__["MatIconModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_13__["MatSelectModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_14__["MatDialogModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppComponentsChatPageGlobalChatGlobalChatComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _related_chats_related_chats_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./related-chats/related-chats.component */
    "./src/app/components/chat-page/global-chat/related-chats/related-chats.component.ts");
    /* harmony import */


    var _message_view_message_view_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../message-view/message-view.component */
    "./src/app/components/chat-page/message-view/message-view.component.ts");
    /* harmony import */


    var _subscribers_view_subscribers_view_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var GlobalChatComponent = /*#__PURE__*/function () {
      function GlobalChatComponent(chatService, route, usersService, router) {
        ...
        this.router = router; //Reloads when params change 
    ...
    GlobalChatComponent.ɵfac = function GlobalChatComponent_Factory(t) {
      return new (t || GlobalChatComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_chat__WEBPACK_IMPORTED_MODULE_1__["ChatService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_users__WEBPACK_IMPORTED_MODULE_2__["UsersService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
    };
    ...
    GlobalChatComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 7,
      vars: 0,
      consts: [[2, "margin", "auto", "max-width", "2000px"], [1, "left"], [1, "middle"], [1, "right"]],
  ...
  function srcAppComponentsHomePageHomePageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _chat_display_chat_display_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./chat-display/chat-display.component */
    "./src/app/components/home-page/chat-display/chat-display.component.ts");
    /* harmony import */


    var _popular_chats_popular_chats_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./popular-chats/popular-chats.component */
    "./src/app/components/home-page/popular-chats/popular-chats.component.ts");
    /* harmony import */


    var _recent_chats_recent_chats_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./recent-chats/recent-chats.component */
    "./src/app/components/home-page/recent-chats/recent-chats.component.ts");
    /* harmony import */


    var _recommended_chats_recommended_chats_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./recommended-chats/recommended-chats.component */
    "./src/app/components/home-page/recommended-chats/recommended-chats.component.ts");
    ...
    var HomePageComponent = /*#__PURE__*/function () {
      ...
      _createClass(HomePageComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.chatsService.getPopularChatIds().then(function (resolve) {
            for (var i = 0; i < resolve.length; i++) {
              var chatId = resolve[i];
            ...
            _this18.chatsService.getRecentChatIds().then(function (resolve) {
              for (var i = 0; i < resolve.length; i++) {
                var _chatId = resolve[i];

                if (chatIds.indexOf(_chatId) === -1) {
                  chatIds.push(_chatId);
                }
              }

              _this18.chatsService.getRecommendedChatIds().then(function (resolve) {
                for (var i = 0; i < resolve.length; i++) {
                  var _chatId2 = resolve[i];

                  if (chatIds.indexOf(_chatId2) === -1) {
                    chatIds.push(_chatId2);
                  }
                }

                if (_this18.chatsService.selectedChatId === "--") {
                  _this18.chatsService.setSelectedChatId(chatIds[0]);
                }

                _this18.chatsService.getChats(chatIds);
              });
            });
          });
        }
    ...
    HomePageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 12,
      vars: 2,
      consts: [[1, "left"], [3, "headerText", "imageUrl"], [1, "middle"], [1, "right"], [1, "chat-list-container"]],
  ...
  /***/
  function srcAppComponentsHomePagePopularChatsPopularChatsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PopularChatsComponent", function () {
      return PopularChatsComponent;
    });
    /* harmony import */
    ...
    var PopularChatsComponent = /*#__PURE__*/function () {
      function PopularChatsComponent(chatsService) {
        _classCallCheck(this, PopularChatsComponent);

        this.chatsService = chatsService;
        this.chatIds = [];
      }

      _createClass(PopularChatsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this19 = this;

          this.chatsService.getPopularChatIds().then(function (chatIds) {
            _this19.chatIds = chatIds;
          });
        }
      }]);
    ...
    PopularChatsComponent.ɵfac = function PopularChatsComponent_Factory(t) {
      return new (t || PopularChatsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_chats__WEBPACK_IMPORTED_MODULE_1__["ChatsService"]));
    };

    PopularChatsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: PopularChatsComponent,
      selectors: [["app-popular-chats"]],
      decls: 4,
      vars: 4,
      consts: [[1, "container"], [3, "headerText", "imageUrl"], [1, "chat-selection-container"], [3, "chatIds", "color"]],
      template: function PopularChatsComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PopularChatsComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsHomePageRecentChatsRecentChatsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RecentChatsComponent", function () {
      return RecentChatsComponent;
    });
    /* harmony import */
    ...
    var RecentChatsComponent = /*#__PURE__*/function () {
      function RecentChatsComponent(chatsService) {
        _classCallCheck(this, RecentChatsComponent);

        this.chatsService = chatsService;
        this.chatIds = [];
      }

      _createClass(RecentChatsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this20 = this;

          this.chatsService.getRecentChatIds().then(function (chatIds) {
            _this20.chatIds = chatIds;
          });
        }
      }]);
    ...
    RecentChatsComponent.ɵfac = function RecentChatsComponent_Factory(t) {
      return new (t || RecentChatsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_chats__WEBPACK_IMPORTED_MODULE_1__["ChatsService"]));
    };

    RecentChatsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: RecentChatsComponent,
      selectors: [["app-recent-chats"]],
      decls: 4,
      vars: 4,
      consts: [[1, "container"], [3, "headerText", "imageUrl"], [1, "chat-selection-container"], [3, "chatIds", "color"]],
      template: function RecentChatsComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RecentChatsComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsHomePageRecommendedChatsRecommendedChatsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RecommendedChatsComponent", function () {
      return RecommendedChatsComponent;
    });
    /* harmony import */
    ...
    var RecommendedChatsComponent = /*#__PURE__*/function () {
      function RecommendedChatsComponent(chatsService) {
        _classCallCheck(this, RecommendedChatsComponent);

        this.chatsService = chatsService;
        this.chatIds = [];
      }

      _createClass(RecommendedChatsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this21 = this;

          this.chatsService.getRecommendedChatIds().then(function (chatIds) {
            _this21.chatIds = chatIds;
          });
        }
      }]);
    ...
    RecommendedChatsComponent.ɵfac = function RecommendedChatsComponent_Factory(t) {
      return new (t || RecommendedChatsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_chats__WEBPACK_IMPORTED_MODULE_1__["ChatsService"]));
    };

    RecommendedChatsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: RecommendedChatsComponent,
      selectors: [["app-recommended-chats"]],
      decls: 4,
      vars: 4,
      consts: [[1, "container"], [3, "headerText", "imageUrl"], [1, "chat-selection-container"], [3, "chatIds", "color"]],
      template: function RecommendedChatsComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RecommendedChatsComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppComponentsNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _image_fab_image_fab_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../image-fab/image-fab.component */
    "./src/app/components/image-fab/image-fab.component.ts");

    function NavbarComponent_div_6_app_user_icon_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function NavbarComponent_div_6_app_image_fab_2_Template(rf, ctx) {
      if (rf & 1) {
      ...
      _createClass(RegisterPageComponent, [{
        ...
        value: function register(registerForm) {
          ...
          this.authService.register(username, email, password).then(function (resolve) {
            _this24.errorMessage = resolve;
            _this24.registering = false;
          });
  ...
  function srcAppComponentsUserPageUserPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_authentication__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/services/authentication */
    "./src/app/services/authentication.ts");
    /* harmony import */
    ...
    var _user_chats_view_user_chats_view_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./user-chats-view/user-chats-view.component */
    "./src/app/components/user-page/user-chats-view/user-chats-view.component.ts");
    /* harmony import */


    var _user_friends_view_user_friends_view_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var UserPageComponent = /*#__PURE__*/function () {
      ...
      _createClass(UserPageComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userSub = this.userService.getUserUpdated().subscribe(function (user) {
            _this27.user = user; //Collects needed chat subs from database if they have not already been collected

            if (_this27.chatsService.chats === undefined || _this27.chatsService.chats === null) {
              var chatIds = [];

              for (var i = 0; i < _this27.user.chatIds.length; i++) {
                var chatId = _this27.user.chatIds[i];
              ...
              _this27.chatsService.getChats(chatIds);
            } //Collect needed user subs from database if they have not already been collected


            if (_this27.usersService.users === undefined || _this27.usersService.users === null) {
              var userIds = [];

              for (var i = 0; i < _this27.user.friendIds.length; i++) {
                var userId = _this27.user.friendIds[i];
              ...
              for (var i = 0; i < _this27.user.friendReqIds.length; i++) {
                var _userId2 = _this27.user.friendReqIds[i];
              ...
              _this27.usersService.getUsers(userIds);
            }
          });
          this.userService.getUser();
        }
    ...
    UserPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 3,
      consts: [["class", "left", 4, "ngIf"], ["class", "middle", 4, "ngIf"], ["class", "right", 4, "ngIf"], [1, "left"], [1, "middle"], [1, "right"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserPageComponent, [{
        ...
        return [{
          ...
          type: src_app_services_authentication__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"]
        }, {
          type: src_app_services_chats__WEBPACK_IMPORTED_MODULE_1__["ChatsService"]
        }, {
          type: src_app_services_users__WEBPACK_IMPORTED_MODULE_2__["UsersService"]
      ...
      _createClass(UserViewComponent, [{
        ...
        value: function onImageSelected(event) {
          ...
          reader.onload = function () {
            ...
            _this29.scaleImage(originalDataUrl, 400, 400, _this29.selectedImage.type, 0.7, function (dataUrl) {
              _this29.selectedImageUrl = dataUrl;
            });
          };
        } //https://codepen.io/shrinivas93/pen/xdLLPN
      ...
      _createClass(AuthenticationService, [{
        ...
        value: function register(username, email, password) {
          ...
          return new Promise(function (resolve) {
            ...
            _this30.http.post(BASE_URL + "register/createUser", body, {
              headers: headers
        ...
        value: function login(email, password) {
          ...
          return new Promise(function (resolve) {
            ...
            _this31.http.post(BASE_URL + "login/authenticate", body, {
              headers: headers
            }).subscribe(function (res) {
              if (res.status === '0') {
                var accessToken = res.data;
                ...
                if (accessToken) {
                  ...
                  _this31.setUserStatusOnline().then(function () {
                    return _this31.go("");
                  });
                }
              } else {
        ...
        value: function setUserStatusOnline() {
          ...
          return new Promise(function (resolve, reject) {
            _this32.http.get(BASE_USER_URL + "userOnline").subscribe(function (res) {
              console.log(res);
      ...
      _createClass(ChatCreateService, [{
        ...
        value: function postChat(title, adminId, category, global) {
          ...
          this.http.post(BASE_URL + "chat-create/create", body, {
            ...
            _this33.postTags(_this33.newChat.tags, res).then(function () {
              return _this33.postCategory(category, res).then(function () {
                //Visit then chat once it's been created
                _this33.go("api/chat/view/" + res);
              });
            });
          });
        ...
        value: function postTags(tags, chatId) {
          ...
          return new Promise(function (resolve, reject) {
            for (var i = 0; i < tags.length; i++) {
              ...
              _this34.http.post(BASE_URL + "chat-create/addTag", body, {
                headers: headers
              }).subscribe(function (res) {
        ...
        value: function postCategory(category, chatId) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this35.http.post(BASE_URL + "chat-create/addCategory", body, {
              headers: headers
            }).subscribe(function (res) {
              return console.log(res);
            });
    ...
    var ChatsService = /*#__PURE__*/function () {
      ...
      _createClass(ChatsService, [{
        ...
        value: function getRecentChatIds() {
          ...
          return new Promise(function (resolve) {
            _this42.http.get(BASE_URL + "chatIds/recent").subscribe(function (res) {
        ...
        value: function getPopularChatIds() {
          ...
          return new Promise(function (resolve) {
            _this43.http.get(BASE_URL + "chatIds/popular").subscribe(function (res) {
              var chatIds = res.data;
              resolve(chatIds);
            });
          });
        ...
        value: function getRecommendedChatIds() {
          ...
          return new Promise(function (resolve) {
            _this44.http.get(BASE_URL + "chatIds/recommended").subscribe(function (res) {
              var chatIds = res.data;
              resolve(chatIds);
            });
          });
      ...
      _createClass(UserService, [{
        ...
        value: function acceptFriendRequest(requestId) {
          ...
          this.http.post(BASE_URL + "accept-request", body, {
            ...
            if (res.status === '0') {
              var index = _this47.user.friendReqIds.indexOf(requestId);

              if (index !== -1) {
                _this47.user.friendReqIds.splice(index, 1);

                _this47.updateUser();
              }

              _this47.user.friendIds.push(requestId);
        ...
        value: function declineFriendRequest(requestId) {
          ...
          this.http.post(BASE_URL + "decline-request", body, {
            ...
            if (res.status === "0") {
              var index = _this48.user.friendReqIds.indexOf(requestId);

              if (index !== -1) {
                _this48.user.friendReqIds.splice(index, 1);
        ...
        value: function setUserStatusOffline() {
          ...
          return new Promise(function (resolve, reject) {
            _this50.http.get(BASE_URL + "userOffline").subscribe(function (res) {
              console.log(res);
              resolve(0);
            });
          });
      ...
      _createClass(UsersService, [{
        ...
        value: function getUser(userId) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this52.http.get(BASE_URL + "data/" + userId).subscribe(function (userSub) {
              resolve(userSub);
            });
          });
